package com.nationsandkings.entity.animation;
...
public class genericVillagerAnim {
    public static final Animation GENERIC_WALK = Animation.Builder.create(2f).looping()
